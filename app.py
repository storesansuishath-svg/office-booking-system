            ...
            for item in pending_items:
                with st.container(border=True):
                    ...
                    with col3:
                        ...
                        if btn_approve.button("✅", key=f"app_{item['id']}", use_container_width=True):
            ...
            with st.expander("คลิกเพื่อแก้ไขรายการ"):
                ...
                if st.button("💾 บันทึกการแก้ไข"):
                    if new_pw == "1234":
                        ...
                        supabase.table("bookings").update(update_vals).eq("id", edit_id).execute()
