...
if st.button("ยืนยันการส่งคำขอจอง"):
        # --- วางส่วน "แถมท้าย" (Validation) ตรงนี้ครับ ---
        if not name or not phone or not reason or not dept:
            ...
            # ถ้าเช็คผ่านหมดแล้วค่อยให้ทำงานส่วนนี้ (ส่งข้อมูลเข้า Supabase)
            # ... โค้ดส่วนตรวจสอบการจองซ้ำและการ Insert ข้อมูลเดิมของคุณ ...
